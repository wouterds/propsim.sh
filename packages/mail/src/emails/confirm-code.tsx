...
export const ConfirmCode = ({ to, code, expiresInMinutes }: ConfirmCodeProps) => (
  ...
  <Layout
    ...
    footnote="You are receiving this because somebody entered this address when creating a propsim account. If that was not you, no account has been activated and you can ignore this message."
    to={to}
  >
    ...
    <Text style={warning}>propsim will never ask you for this code.</Text>
  </Layout>
);
