  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        body: [
          "The cap is on net contracts held, added up across every contract, and it scales with the plan: twenty micros on a 25K, forty on a 50K, sixty on a 100K and a hundred on a 150K.",
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary:
          "Positions are closed for you at 16:45 New York time and trading reopens at 18:00. The accounting day is cut at 17:00 Chicago time, which is the same instant.",
        body: [
          "You are flat by 16:45 New York time, Monday to Friday. Whatever is still open then is closed where it last printed, every working order is cancelled, and a ticket sent while the session is shut is refused. Trading reopens at 18:00 New York time, Sunday to Thursday.",
