            ...
            <div key={plan.id} className="flex flex-col rounded-lg border border-line bg-raised">
              ...
              <div className="mt-auto border-line/70 border-t px-4 py-3">
                <Link
                  ...
                  className="inline-flex h-9 w-full items-center justify-center rounded bg-accent font-medium text-sm text-sunken transition-colors hover:bg-accent/85 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-accent"
                >
                  Open this account
                </Link>
              </div>
