        ...
        {actionData?.sent ? (
          ...
          <Form method="post" className="mt-10 max-w-xl space-y-4">
            ...
            <button
              type="submit"
              disabled={busy}
              className="inline-flex h-10 items-center rounded bg-accent-strong px-5 font-medium text-sm text-white transition-colors hover:bg-accent-strong/85 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-accent disabled:opacity-60"
            >
              {busy ? "Sending" : "Send"}
            </button>
          </Form>
