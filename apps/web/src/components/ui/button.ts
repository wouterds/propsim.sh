...
export const PRIMARY = `${BASE} h-10 bg-accent-strong px-5 text-white hover:bg-accent-strong/85`;
...
export const PRIMARY_SM = `${BASE} h-9 bg-accent-strong px-4 text-white hover:bg-accent-strong/85`;
...
export const DANGER = `${BASE} h-9 bg-down px-4 text-white hover:bg-down/85`;
